...
class AccountAccount(models.Model):
    ...
    def _l10n_ar_reports_simple_improvements_concept_tag_ids(self):
        ...
        return self.env['account.account.tag'].browse([
            ...
            self.env.ref('l10n_ar_reports_simple_improvements.tag_goods_account').id,
            self.env.ref('l10n_ar_reports_simple_improvements.tag_services_account').id,
        ])

    @api.constrains('tag_ids')
    def _check_l10n_ar_reports_simple_improvements_single_concept_tag(self):
        concept_tags = self._l10n_ar_reports_simple_improvements_concept_tag_ids()
        for account in self:
